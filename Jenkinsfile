      ...
      steps {
        nvm('version': 'v14.2.0') {
          sh '''
            ...
            pnpm clean
            PG_NAME=postgres PG_HOST=localhost PG_USER=postgres REDIS_HOST=localhost pnpm test:eslint
            PG_NAME=postgres PG_HOST=localhost PG_USER=postgres REDIS_HOST=localhost pnpm test:unit
          '''
        }
      }
    }
